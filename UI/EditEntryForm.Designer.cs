namespace UI
{
	partial class EditEntryForm
	{
		...
		private void InitializeComponent()
		{
			...
			this._btnCacnel.Location = new System.Drawing.Point(321, 3);
			...
			this._btnUpdate.Location = new System.Drawing.Point(251, 3);
			...
			this._btnUpdate.Click += new System.EventHandler(this.BtnSaveClick);
			// 
			// _tableLayoutPanel
			// 
			...
			this._tableLayoutPanel.Size = new System.Drawing.Size(394, 387);
			this._tableLayoutPanel.TabIndex = 4;
			// 
			// _layoutEditorControls
			// 
			this._layoutEditorControls.ColumnCount = 1;
			this._layoutEditorControls.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			...
			this._layoutEditorControls.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 90.17341F));
			this._layoutEditorControls.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 9.82659F));
			this._layoutEditorControls.Size = new System.Drawing.Size(388, 346);
			...
			this.MaximumSize = new System.Drawing.Size(410, 1024);
